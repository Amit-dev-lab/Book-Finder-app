...
const AppProvider = ({ children }) => {
  // 🔹 Default search (so homepage is never empty)
  ...
  const fetchBooks = useCallback(async () => {
    ...
    try {
      ...
      if (docs) {
        ...
        // 🔹 Show different titles for default vs search
        if (searchTerm.toLowerCase() === "harry potter") {
          setResultTitle("Popular Books");
